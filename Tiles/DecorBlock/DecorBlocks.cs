...
namespace DecoTiles.Tiles.DecorBlock
{
	...
	internal class LabPlatformTile : ModTile
	{
        ...
        {
            QuickBlock.QuickSetPlatform(this, 0, 191, SoundID.Dig, false, ItemType<Items.DecorBlockItem.LabPlatform>(), "");
        }
    }
	...
	internal class ThickWoodPlatformTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSetPlatform(this, 0, 7, SoundID.Dig, false, ItemType<Items.DecorBlockItem.ThickWoodPlatform>(), "");
        }
    }
	...
	internal class AlysianPlatingPlatformTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSetPlatform(this, 0, 261, SoundID.Tink, false, ItemType<Items.DecorBlockItem.AlysianPlatingPlatform>(), "");
        }
    }
	...
	internal class GrassPlatformTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSetPlatform(this, 0, 3, SoundID.Dig, false, ItemType<Items.DecorBlockItem.GrassPlatform>(), "");
        }
    }
	...
	internal class BlackBrickPlatformTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSetPlatform(this, 0, 191, SoundID.Tink, false, ItemType<Items.DecorBlockItem.BlackBrickPlatform>(), "");
        }
    }
	//^Platform Tiles^ --------------------------------------------------------------------------------------
	...
	internal class BlackBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 191, SoundID.Tink, new Color(40, 39, 47), ItemType<Items.DecorBlockItem.BlackBrick>(), true, false, false, "");
        }
    }
	...
	internal class OfficeFloorTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 0, 191, SoundID.Tink, new Color(40, 39, 47), ItemType<Items.DecorBlockItem.OfficeFloor>(), true, false, false, "");
        }
    }

	internal class CosmicCystTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 0, 191, SoundID.Tink, new Color(45, 14, 82), ItemType<Items.DecorBlockItem.CosmicCyst>(), true, false, false, "");
        }
    }
	...
	internal class FieryBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 0, 191, SoundID.Tink, new Color(255, 84, 0), ItemType<Items.DecorBlockItem.FieryBrick>(), true, false, false, "");
        }
    }
	...
	internal class FertileDirtTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 0, 191, SoundID.Tink, new Color(90, 42, 42), ItemType<Items.DecorBlockItem.FertileDirt>(), true, false, false, "");
        }
    }
	...
	internal class PenumbraPlateTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 0, 191, SoundID.Tink, new Color(90, 42, 42), ItemType<Items.DecorBlockItem.PenumbraPlate>(), false, false, false, "");
        }
	}
	...
	internal class MagnetBlockTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 0, 191, SoundID.Tink, new Color(255, 84, 0), ItemType<Items.DecorBlockItem.MagnetBlock>(), true, false, false, "");
        }
    }
	...
	internal class CoalstoneTile : ModTile
	{
		...
		public void NearbyEffects(int i, int j, Player player, NPC npc)
        {
			if (Vector2.Distance(new Vector2(i, j), Main.npc[i].position) < 2000)
            {
	...
	internal class RedLegoBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 117, SoundID.Tink, new Color(226, 64, 64), ItemType<Items.DecorBlockItem.RedLegoBrick>(), true, false, false, "");
        }
    }
	...
	internal class BlackLegoBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 37, SoundID.Tink, new Color(53, 53, 53), ItemType<Items.DecorBlockItem.BlackLegoBrick>(), true, false, false, "");
        }
    }
	...
	internal class GreenLegoBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 273, SoundID.Tink, new Color(26, 158, 62), ItemType<Items.DecorBlockItem.GreenLegoBrick>(), true, false, false, "");
        }
    }
	...
	internal class WhiteLegoBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 76, SoundID.Tink, new Color(204, 204, 204), ItemType<Items.DecorBlockItem.WhiteLegoBrick>(), true, false, false, "");
        }
    }
	...
	internal class YellowLegoBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 153, SoundID.Tink, new Color(232, 223, 67), ItemType<Items.DecorBlockItem.YellowLegoBrick>(), true, false, false, "");
        }
    }
	...
	internal class BlueLegoBrickTile : ModTile
	{
        public override void SetDefaults()
        {
            QuickBlock.QuickSet(this, 65, 253, SoundID.Tink, new Color(72, 64, 221), ItemType<Items.DecorBlockItem.BlueLegoBrick>(), true, false, false, "");
        }
    }
}
